...
Replace `4.3.2.1` with a reversed IP you expect to be listed (one that SwarmGuard has scored above threshold), and `dnsbl.swarmguard.mail.` with your actual zone name.
